...
N_random = 10000
Covariance = 0;
# This flag is used to select weather calculating the Risk just adding first all the Returns
# and computing the std or using the Covariance matrix, the result is almost the same.
best_Allocation = H1.plot_efficient_frontier(start_date, end_date, symbols, keys,N_random, Covariance)
...
#N_random = 1000
#Covariance = 0;
#best_Allocation = H1.plot_covariance(start_date, end_date, symbols, keys,N_random, Covariance)
